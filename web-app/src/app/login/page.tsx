...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (error) {
            setError('Email atau kata sandi tidak sesuai. Silakan periksa kembali akun admin Sisca.');
            setIsLoading(false);
            return;
        }
            ...
            <section className="relative z-10 mx-auto grid min-h-[calc(100svh-64px)] max-w-6xl items-center gap-12 px-5 py-10 md:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:py-14">
                ...
                <div className="hidden lg:block">
                    ...
                    <p className="mt-6 max-w-lg text-[16px] font-medium leading-8 text-slate-500">
                        Masuk ke dashboard Sisca untuk mengelola knowledge base, memantau chat mahasiswa, dan menindaklanjuti tiket laporan SSC.
                    </p>
                ...
                <div className="mx-auto w-full max-w-[450px]">
                    <div className="mb-8 text-center lg:hidden">
                        ...
                        <h1 className="text-3xl font-semibold tracking-[-0.035em] text-slate-950">Sisca Workspace</h1>
                    ...
                    <div className="rounded-[2rem] border border-slate-200/70 bg-white p-6 shadow-[0_30px_90px_-55px_rgba(15,23,42,0.55)] sm:p-8">
                        <div className="mb-8 hidden items-center gap-3 lg:flex">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold tracking-tight text-slate-950">Masuk ke Sisca</h2>
                                <p className="mt-1 text-[13px] font-medium text-slate-500">Akses terbatas untuk staf/admin SSC.</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            <div>
                                <label htmlFor="email" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                                    Email Admin
                                </label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="h-12 w-full rounded-2xl border border-slate-200 bg-white pl-11 pr-4 text-[14px] font-medium text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-slate-900 focus:ring-4 focus:ring-slate-100"
                                        placeholder="admin@tus.ac.id"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="mb-2 flex items-center justify-between gap-4">
                                    ...
                                    <a href="/forgot-password" className="text-[12px] font-semibold text-slate-500 transition-colors hover:text-slate-900">
                                        Lupa kata sandi?
                                    </a>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="h-12 w-full rounded-2xl border border-slate-200 bg-white pl-11 pr-12 text-[14px] font-medium text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-slate-900 focus:ring-4 focus:ring-slate-100"
                                        placeholder="Masukkan kata sandi"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword((prev) => !prev)}
                                        className="absolute right-3 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-xl text-slate-400 transition-colors hover:bg-slate-50 hover:text-slate-700"
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-slate-900 text-[14px] font-semibold text-white shadow-[0_18px_40px_-24px_rgba(15,23,42,0.9)] transition-all hover:-translate-y-0.5 hover:bg-slate-800 disabled:translate-y-0 disabled:bg-slate-200 disabled:text-slate-500"
                            >
                                {isLoading ? (
                                    <>
                        ...
                        <div className="my-7 flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-medium text-slate-400">Sisca Platform</span>
                            <div className="h-px flex-1 bg-slate-100" />
                        </div>
                        ...
                        <div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-100">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-[13px] font-semibold text-slate-800">Akses internal SSC</p>
                                    <p className="mt-1 text-[12px] font-medium leading-5 text-slate-500">
                                        Gunakan akun admin resmi untuk mengelola dokumen, riwayat chat, dan laporan mahasiswa.
                                    </p>
                                </div>
                            </div>
                        </div>
